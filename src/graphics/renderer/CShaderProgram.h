...
{
public:
	CShaderProgram(TShaderObject<GL_VERTEX_SHADER>* vertex, TShaderObject<GL_GEOMETRY_SHADER>* geometry, TShaderObject<GL_TESS_CONTROL_SHADER>* tessControl, TShaderObject<GL_TESS_EVALUATION_SHADER>* tessEval, TShaderObject<GL_FRAGMENT_SHADER>* fragment);
	~CShaderProgram();

	bool init(TShaderObject<GL_VERTEX_SHADER>* vertex, TShaderObject<GL_GEOMETRY_SHADER>* geometry, TShaderObject<GL_TESS_CONTROL_SHADER>* tessControl, TShaderObject<GL_TESS_EVALUATION_SHADER>* tessEval, TShaderObject<GL_FRAGMENT_SHADER>* fragment);
