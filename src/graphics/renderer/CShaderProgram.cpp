...
CShaderProgram::CShaderProgram(TShaderObject<GL_VERTEX_SHADER>* vertex, TShaderObject<GL_GEOMETRY_SHADER>* geometry, TShaderObject<GL_TESS_CONTROL_SHADER>* tessControl, TShaderObject<GL_TESS_EVALUATION_SHADER>* tessEval, TShaderObject<GL_FRAGMENT_SHADER>* fragment)
	:
	m_programId(0),
	m_valid(false)
{
	init(vertex, geometry, tessControl, tessEval, fragment);
}
...
bool CShaderProgram::init(TShaderObject<GL_VERTEX_SHADER>* vertex, TShaderObject<GL_GEOMETRY_SHADER>* geometry, TShaderObject<GL_TESS_CONTROL_SHADER>* tessControl, TShaderObject<GL_TESS_EVALUATION_SHADER>* tessEval, TShaderObject<GL_FRAGMENT_SHADER>* fragment)
{
	// Needs vertex shader
...
const std::string& CShaderProgram::getErrorString() const
{
	return m_infoLog;
}
