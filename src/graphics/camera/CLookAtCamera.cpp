...
const glm::mat4& CLookAtCamera::getView() const
{
	return m_view;
}
...
const glm::mat4& CLookAtCamera::getProjection() const
{
	return m_proj;
}

float CLookAtCamera::getAspectRatio() const
{
	return m_aspectRatio;
}

float CLookAtCamera::getFieldOfView() const
{
	return m_fieldOfView;
}

float CLookAtCamera::getZNear() const
{
	return m_zNear;
}

float CLookAtCamera::getZFar() const
{
	return m_zFar;
}

const glm::vec3& CLookAtCamera::getPosition() const
{
	return m_position;
}