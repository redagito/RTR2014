...
{
public:
	typedef std::function<SampleType(KeyType key0, SampleType value0, KeyType key1, SampleType value1, KeyType key2, SampleType value2, KeyType key)> InterpolationFunction;
...
template <typename SampleType, typename KeyType>
TSampler<SampleType, KeyType>::TSampler(InterpolationFunction interpolFunc, unsigned int initSizeAlloc)
	:
	m_interpolationFunction(interpolFunc),
	m_currIndex(0)
{
